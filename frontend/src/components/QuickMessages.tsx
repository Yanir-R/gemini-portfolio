...
const QuickMessageButton: React.FC<QuickMessageButtonProps> = ({
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute inset-0 bg-gradient-to-r from-brand-purple/0 via-[#b65eff]/5 to-[#9d4edd]/0 
            ...
            <div
                className="relative flex justify-center items-center w-6 h-6 rounded-md
